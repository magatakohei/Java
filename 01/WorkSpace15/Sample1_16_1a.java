...
public class Sample1_16_1a {
	public static void main(String[] args) {
		...
		/*
		 * //★インスタンスinstanceCalから現在の月日に関する情報を取得して画面表示する // - instanceCal.get(
		 * Calendar.MONTH ) … インスタンスinstanceCalより現在の月に関する値※を取得します //
		 * ※月の値は1月=0,2月=1,…,12月=11（0からカウント）で値を返します // - instanceCal.get( Calendar.DATE )
		 * … インスタンスinstanceCalより現在の日に関する値※を取得します // ※日の値は1日=1,2日=2,…（1からカウント）で値を返します //
